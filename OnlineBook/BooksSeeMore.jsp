...
<body>
    ...
    justify-content: space-between !important;">
                            <li class="nav-item">
                                <a class="nav-link text-uppercase text-white" href="BookStore.jsp">Home</a>
                            </li>
							...
							<li class="nav-item">
                                <a class="nav-link text-uppercase createline text-white" href="About.jsp">About</a>
                            </li>
                        </ul>
                    </div>
                    <a href="login.jsp"><i class="feather-shopping-cart mx-lg-5 text-white d-none d-lg-block" ></i></a>
   ...
   <center><h2><%=(request.getAttribute("success") == null) ? "" : request.getAttribute("success")%></h2></center>
    	<%--Books Category--%>
...
<div class="popular container mt-3 mb-3 mt-lg-4">
    ...
    overflow: hidden;"> <%=name%></h5>
                            ...
                            <div class="order">
                           		<input type="submit" class="btn btn-outline-primary btn-sm cart" name="<%=id%>" value="Add to Cart">
                            </div>
