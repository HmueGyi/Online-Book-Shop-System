                ...
                <div class="row sticky-top ">
                        ...
                        <div class="row">
                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Qauntity</li>
                                </ol>
                            </nav>
                        </div>
                            <!-- </div> -->
...
<script type="text/javascript">
		function confirmEditQuantity(id,category) {

			var del = confirm("Are you sure you want to edit quantity?")

			if (del) {
				
				window.document.myForm.action = "EditQuantityServlet?bookid=" + id;
				window.document.myForm.submit();
			}
			else{
				alert("Edit cancelled!")
				window.document.myForm.action = "EditBookQuantity2.jsp?category=" + category;
				window.document.myForm.submit();
			}
...
<center><font color="blue"><h1>Book List</h1>	
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td><input type="text" name='q<%=id%>' value=<%=quantity%>><br>
					<input type="submit" name="EditQty" value="Edit Quantity"
					onclick="confirmEditQuantity('<%=id%>','<%=category%>')">
				</td>
