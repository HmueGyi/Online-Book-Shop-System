	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("Btn Value"+req.getParameter("EditQty"));
			...
			Connection conn = DBConnection.getConn();
					...
					System.out.println("Quantity=" + req.getParameter('q'+id));
					ps.setString(1, req.getParameter('q'+id));
					ps.setString(2, id);
					ps.executeUpdate();
					...
					req.getRequestDispatcher("EditBookQuantity2.jsp?category="+category).forward(req, resp);
